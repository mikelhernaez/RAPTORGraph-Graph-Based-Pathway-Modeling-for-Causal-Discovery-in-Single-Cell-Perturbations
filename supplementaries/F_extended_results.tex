...
% \begin{figure}[ht]
%     \centering
%     \includegraphics[width=0.75\linewidth]{gfx/results/hit_rate_at_k_relevant_gene_overlap.png}
%     \caption{Hit Rate @ K (relevant) for the reverse perturbation task.
...
\toprule
\textbf{$eta$} & \textbf{$\mu$} & \textbf{$\lambda_1$} & \textbf{KL Divergence} & \textbf{Pred. Var.} & \textbf{\gls{mmd}} \\
\midrule
