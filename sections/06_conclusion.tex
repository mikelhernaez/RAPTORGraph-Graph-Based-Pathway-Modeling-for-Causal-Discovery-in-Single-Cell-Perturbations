...
We acknowledge that \gls{raptorgraph} has certain limitations, which are discussed in \cref{app:crl_methods}. Future work will focus on deploying \gls{raptorgraph} for the hypothesis-driven discovery of novel drug targets and exploring its utility in uncovering cell-type specific pathway mechanisms.
